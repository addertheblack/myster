...
/**
 * All classes who wish to be registered as offical transport protocols Need to
 ...
 * through the correct manager. This is so brilliant. I'm glad I thought of it
 * :-)..
 * 
 * Transport Listener
 */
...
public abstract class DatagramTransport implements DatagramSender {
     ...
     */
    protected final void setSender(DatagramSender sender) { //don't over-ride
                                                            // (or even access)
    ...
    public abstract void packetReceived(ImmutableDatagramPacket p)
