...
public class MysterSocketFactory {
	...
	public static MysterSocket makeStreamConnection(MysterAddress ip) throws IOException {
		return new TCPSocket(makeTCPSocket(ip));
	}
	
	public static void makeTransactionConnection(MysterAddress ip) throws IOException { //TBD to be done
