...
public abstract class TransactionProtocol {
	...
	public abstract int getTransactionCode(); 	//returns the transaction code of the transaction protocol.
	...
	*
	*	It is a private API that I cannot close access to by those who 
	*	inherit from this class.
	*
	*	Presumably the setSender method will be replaced by a call to a static manager inside this class (?)
	*
	*	Is there a book on building frameworks with data hiding for Java? :-)
	*/
	protected final void setSender(TransactionSender sender) { //should only be acces by manager
