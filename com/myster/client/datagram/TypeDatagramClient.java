...
public class TypeDatagramClient implements StandardDatagramClientImpl {
	public static final int TYPE_TRANSACTION_CODE = 74; //There is no UDP version of the first version of get file type list.
	...
	public byte[] getDataForOutgoingPacket() { return new byte[]{}; }

	public int getCode() { return TYPE_TRANSACTION_CODE; }
}