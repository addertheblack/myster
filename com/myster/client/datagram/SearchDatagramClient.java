...
public class SearchDatagramClient implements StandardDatagramClientImpl{
	public static final int SEARCH_TRANSACTION_CODE = 35; //There is no UDP version of the first version of get file type list.
	...
	//NOTE: The UDP version of this section (below) is different than the older TCP veison and WILL cause problems
	//		if the txt encoding of the type in question is outside the first 7 bits (ascii) and the
	...
	//returns Vector of Strings
	public Object getNullObject ()  { return new Vector(); }
	...
	public int getCode() { return SEARCH_TRANSACTION_CODE; }
}