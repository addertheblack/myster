...
/**
* Unlike most other modules in Myster, the hash package hash a clear
* frontend / backend seperation even with it's preferences. This 
* should allow preferences to be set from any interface and not 
* just privately. it does, however, mean more coding for me, which 
* is why I don't usually bother. In this case it proves usefull, but not very.
*/
