...
public class HashSearchResult implements SearchResult {
	...
	public String getNetwork() { return "Myster"; }
	...
	public String[] getKeyList() { return new String[]{}; }
	
	//gets the Name of the search result (usualy a file name!)
	public String getName() { return stub.getName(); }
	
	//gets the host address
	public MysterAddress getHostAddress() { return stub.getMysterAddress(); }
}