...
public class MysterSearch extends MysterThread {
    ...
    public MysterSearch(SearchResultListener listener, Sayable msg,
            MysterType type, String searchString) {
        this.msg = msg;
    ...
    public void run() {
        ...
        MysterServer[] iparray = IPListManagerSingleton.getIPListManager()
                .getTop(type, 50);
        ...
        if (i == 0) {
            String[] lastresort = IPListManagerSingleton.getIPListManager()
                    .getOnRamps();
            //msg.say("ERROR: No search done. Add an IP using the \"AddIP\"
            // command.");
