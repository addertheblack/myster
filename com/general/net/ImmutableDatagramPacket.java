...
/**
	Class used to wrap incomprehensibly stupid behavior of the native java DatagramPacket.
	
	1) Makes packet imutable
	2) No longer have to worry about packet truncation or data.length not matching getLength()
	
	Contains either des address or source address depending on whether it's comming or going.
*/
...
public class ImmutableDatagramPacket {
	...
	*/
	public byte[] getData() {
		...
		System.arraycopy(data, 0, b_temp, 0, data.length); //I hate this nonesence routine.
	...
	/**
		Returns a well formed DatagramPacket representation of the ImutableDatagramPacket
		(Is a COPY)
	*/
