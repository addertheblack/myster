...
public class TabUtilities {
    public static Image makeImage(int p_stringWidth, Component c,
        ...
        if (!isCustom) {
            ...
            g.drawImage(middle, xsize - right.getWidth(c) - middle.getWidth(c),
                    0, c);
    ...
    private static void error(Image i, String g) {
        if (i == null)
            com.general.util.AnswerDialog
                    .simpleAlert("WARNING: The file com.general.util.tab."
                            + g
                            + " could not be found. Please replace this file or tell the developer he forgot to merge it into the program (.jar).");
    }
