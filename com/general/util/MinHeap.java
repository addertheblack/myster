...
public class MinHeap extends AbstractHeap {
    ...
    public MinHeap() { }
    public MinHeap(int initialMemoryAllocation) { super(initialMemoryAllocation); }
    public MinHeap(Comparator comparator) { super(comparator); }
    public MinHeap(int initialMemoryAllocation, Comparator comparator) { super(initialMemoryAllocation, comparator); }
