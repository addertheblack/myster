...
public class MCListHeaderEventHandler extends MouseAdapter implements
        MouseMotionListener {
    MCListHeader header;

    public MCListHeaderEventHandler(MCListHeader h) {
        header = h;
    }
    ...
    public void mousePressed(MouseEvent e) {
        if (resizeEnabled() && header.isOnBorder(e.getX())) {
            ...
            if (header.getSortBy() != columnClicked) {
                ...
                // do nothing.. There's not point in reversing the sort order on
                // a non column selected
            } else {
    ...
    public void mouseDragged(MouseEvent e) {
        if (resizeEnabled() && resizeflag) {
            ...
            header.setColumnWidth(resizeColumn, originalSize
                    + (e.getX() - resizeloc));
    ...
    public void mouseReleased(MouseEvent e) {
        if (resizeEnabled() && resizeflag) {
            ...
            header.getMCLParent().setColumnWidth(resizeColumn,
                    originalSize + (e.getX() - resizeloc)); //updates size as
                                                            // well
