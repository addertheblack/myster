...
public class PingPongPacket {
    ...
    public PingPongPacket(ImmutableDatagramPacket param_packet,
            boolean param_packetType) throws BadPacketException {
        packet = param_packet;
        ...
        if (packetType == PING ? isAPingPacket(packet) : isAPongPacket(packet)) {
            ...
            if (packetType == PING)
                throw new NotAPingPacketException();
            else
                throw new NotAPongPacketException();
        }
    }
