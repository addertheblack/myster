...
public interface MSDownloadListener {
     ...
     */
    void startDownload(StartMultiSourceEvent event);
     ...
     */
    void pauseDownload(MultiSourceEvent event);
    ...
    /**
     * Cleanup is done. Files have been moved/copied or renamed to the final name. Resources have been closed.
     */
