...
class TestFileTypeList {
    ...
    private static class TestTypeDescriptionList implements TypeDescriptionList {
        ...
        @Override
        public void addCustomType(com.myster.type.CustomTypeDefinition customType) {
            // No-op for testing
        }
        ...
        @Override
        public void updateCustomType(MysterType type, com.myster.type.CustomTypeDefinition updatedDefinition) {
            // No-op for testing
        }
